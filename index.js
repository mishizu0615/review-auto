...
const VANILLA_AGES = ['20代前半','20代中盤','20代後半','ヒミツ♡'];
const COCOA_AGES = ['18〜19歳','20〜24歳','25〜29歳'];
const BUSTS = ['Aカップ','Bカップ','Cカップ','Dカップ','Eカップ','Fカップ以上'];
const BODY_TYPES = ['スリム','普通'];
...
async function postCocoa(browser, row) {
  ...
  // 確認するボタンが出るまで待つ
  await page.waitForSelector('button[name="confirm"]', { timeout: 10000 });
  console.log('確認ボタン発見');
